# =============================================================================
# EKS Module — Private Kubernetes Cluster with OIDC Provider
# Production-grade EKS with encryption, logging, and IRSA support
# =============================================================================
...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    endpoint_public_access  = true  # Enabled for local access, but restricted via CIDRs for security
